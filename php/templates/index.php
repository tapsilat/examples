...
<body>
  ...
  <nav class="sidebar">
    ...
    <div class="nav flex-column">
      <a class="nav-link active" onclick="switchView('shop', this)"><i class="fas fa-shopping-cart me-2"></i> New
        Order</a>
      <a class="nav-link" onclick="switchView('orders', this)"><i class="fas fa-list me-2"></i> Order List</a>
      <a class="nav-link" onclick="switchView('subscriptions', this)"><i class="fas fa-sync me-2"></i> Subscriptions</a>
      <a class="nav-link" onclick="switchView('terms', this)"><i class="fas fa-file-invoice-dollar me-2"></i> Payment
        Terms</a>
      <a class="nav-link" onclick="switchView('submerchants', this)"><i class="fas fa-store me-2"></i> Submerchants</a>
      <a class="nav-link" onclick="switchView('organization', this)"><i class="fas fa-building me-2"></i>
        Organization</a>

      <a class="nav-link" onclick="switchView('webhooks', this)"><i class="fas fa-broadcast-tower me-2"></i> Webhook
        Monitor</a>
    </div>
  </nav>
  ...
  <main class="main-content">
      ...
      <div class="card p-4">
        ...
        <div id="shop-step-1" class="shop-step active">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-sm btn-outline-secondary" onclick="randomizeShopValues()">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="shop-3d" checked />
                    <label class="form-check-label">Force 3D</label>
                  </div>
                </div>
                <div class="col-md-3">
                  <label class="form-label">Installment</label>
                  <input type="number" class="form-control" id="shop-installment-count" value="1" />
                </div>
                <div class="col-md-3">
                  <label class="form-label">All Pay Methods</label>
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="shop-pm" checked />
            ...
            <div class="card-body">
              <div class="row g-3">
                <div class="col-md-12">
                  ...
                  <div id="shop-installments-checks" class="d-flex gap-3 flex-wrap">
                    <!-- JS Injected -->
                  </div>
                </div>
                <div class="col-md-12">
                  ...
                  <div class="d-flex gap-3">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="card" id="po-card" checked />
                      <label class="form-check-label" for="po-card">Card</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="bank_transfer" id="po-bank" checked />
                      <label class="form-check-label" for="po-bank">Bank Transfer</label>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                  ...
                  <button class="btn btn-sm btn-outline-secondary" onclick="addMetadataRow()">
                    + Add Metadata
                  </button>
                </div>
              </div>
          ...
          <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <button class="btn btn-sm btn-outline-primary" onclick="addCartItem()">
                + Add Item
              </button>
            </div>
          ...
          <form id="billing-form">
            <div class="row">
              <div class="col-md-6 mb-2">
                <input class="form-control" name="contact_name" value="John Doe" placeholder="Name" />
              </div>
              <div class="col-md-6 mb-2">
                <input class="form-control" name="email" value="john@example.com" placeholder="Email" />
              </div>
              <div class="col-md-6 mb-2">
                <input class="form-control" name="contact_phone" value="5551234567" placeholder="Phone" />
              </div>
              <div class="col-md-6 mb-2">
                <input class="form-control" name="vat_number" value="11111111111" placeholder="VAT/Identity" />
              </div>
              <div class="col-12 mb-2">
                <input class="form-control" name="address" value="Besiktas Main St" placeholder="Address" />
              </div>
              <div class="col-6 mb-2">
                <input class="form-control" name="city" value="Istanbul" placeholder="City" />
              </div>
              <div class="col-6 mb-2">
                <input class="form-control" name="zip_code" value="34000" placeholder="Zip" />
              </div>
    ...
    <div id="view-orders" class="tab-view">
      ...
      <div class="card p-3 mb-3 bg-light">
        <form onsubmit="event.preventDefault(); fetchOrders(1);">
          <div class="row g-2">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
              <label>Org ID</label>
              <input type="text" class="form-control form-control-sm" id="filter-org" placeholder="Organization ID" />
            </div>
            <div class="col-md-2">
              <label>Related Ref ID</label>
              <input type="text" class="form-control form-control-sm" id="filter-ref" placeholder="Ref ID" />
            </div>
            <div class="col-md-2">
              <label>Page</label>
              <div class="input-group input-group-sm">
                <input type="number" class="form-control" id="order-page" value="1" min="1" />
      ...
      <div class="card">
        ...
        <div class="card-footer d-flex justify-content-between">
          <button class="btn btn-sm btn-outline-secondary" onclick="changeOrderPage(-1)">
            Previous
          </button>
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">
                Order Details:
                <span id="detail-id" class="text-primary font-monospace"></span>
              </h5>
              <button class="btn btn-sm btn-outline-secondary ms-2" onclick="copyText('detail-id')">
            ...
            <div class="modal-body">
              <!-- Management Actions -->
              <div class="alert alert-light border d-flex gap-2 justify-content-end mb-4">
                <button class="btn btn-danger btn-sm" onclick="actionOrder('cancel')">
                  <i class="fas fa-ban"></i> Cancel Order
                </button>
                <button class="btn btn-warning btn-sm" onclick="actionOrder('refund')">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  <h6>Raw Data</h6>
                  <pre id="detail-raw" style="max-height: 200px; font-size: 0.8em"></pre>
                </div>
              </div>
              ...
              <div class="text-end mb-2">
                <button class="btn btn-sm btn-success" data-bs-toggle="collapse" data-bs-target="#new-term-form">
                  + Add Term
                </button>
              </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card p-3">
            ...
            <form onsubmit="createSubscription(event)">
              <input class="form-control mb-2" name="name" value="Gold Plan" placeholder="Title" required />
              <input type="number" class="form-control mb-2" name="amount" value="49.90" step="0.01"
        ...
        <div class="col-md-8">
          <div class="card p-3">
            <h4>
              List
              <button class="btn btn-sm btn-light float-end" onclick="fetchSubscriptions()">
                Refresh
              </button>
            </h4>
    ...
    <div id="view-webhooks" class="tab-view">
      ...
      <div class="card">
        ...
        <div class="card-body p-0" id="webhook-list" style="height: 500px; overflow-y: auto">
  ...
  <script>
    ...
    async function fetchOrders(pageOverride) {
      ...
      tbody.innerHTML = json.rows
        .map(
          (o) => `
            <tr style="cursor: pointer" onclick="showOrderDetail('${o.reference_id
            }')">
    ...
    async function showOrderDetail(refId) {
      ...
      document.getElementById("detail-basic").innerHTML = `
            ...
            <tr><th>Payment Status</th><td>${detail.payment_status || "-"
        }</td></tr>
        `;
    ...
    async function fetchSubscriptions() {
      ...
      list.innerHTML = `
          ...
          .map(
            (s) => `
                            <tr>
                                <td class="font-monospace text-primary">${s.reference_id
              } <i class="fas fa-copy copy-btn" onclick="navigator.clipboard.writeText('${s.reference_id
              }')"></i></td>
                                <td>
                                    ${s.is_active
                ...
                : '<span class="badge bg-danger">Inactive</span>'
                                ...
                                <td><span class="badge bg-secondary">${s.payment_status || "N/A"
              }</span></td>
                                <td>${s.amount || "-"} ${s.currency || "TRY"
              }</td>
                                <td>${s.period || "1"}</td>
                                <td>
                                    ${s.checkout_url
                ...
                : "-"
                                ...
                                <td><button class="btn btn-sm btn-outline-danger" onclick="cancelSub('${s.reference_id
              }')">Cancel</button></td>
                            </tr>
                        `
          )
    ...
    function renderTermsTable(terms) {
      ...
      tbody.innerHTML = terms
        .map((t) => {
          return `<tr>
                      <td class="font-monospace">${t.term.term_reference_id || "-"
            }</td>
                      <td class="font-monospace"><a href="#" onclick="showOrderDetail('${t.order
            }')">${t.order}</a></td>
                      <td>${t.term.amount || "-"}</td>
                      <td>${t.term.required
              ...
              : '<span class="badge bg-secondary">Optional</span>'
                      ...
                      <td>${t.term.status || "-"}</td>
                      <td>
                          <button class="btn btn-sm btn-danger" onclick="deleteTerm('${t.order
    ...
    async function fetchSubmerchants() {
      ...
      try {
        ...
        // Handle if json.rows is missing or empty. Adapting to SDK response structure.
        const rows = json.items || json.rows || []; // SDK usually returns 'items' in pagination or direct array? SDK returns whatever API returns.
    ...
    window.fetchSubmerchants = fetchSubmerchants;
    window.fetchOrganizationSettings = fetchOrganizationSettings;
          ...
          listDiv.innerHTML += `
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 text-truncate" title="${log.filename
            }">${log.filename}</h6>
